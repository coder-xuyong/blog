...
app.error=/error/
#123 为map的key
wind.config.mac-map.123.machine-name=test
wind.config.mac-map.123.machine-value=01

#结构：Map<String, List<Machine2>>
wind.config.mac-map2.drive[0].machine-number=01
wind.config.mac-map2.drive[0].machine-id=24112417034462758
wind.config.mac-map2.drive[1].machine-number=02
wind.config.mac-map2.drive[1].machine-id=24122513082778016
```
